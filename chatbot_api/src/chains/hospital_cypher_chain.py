"""
cypher_generation_template: Converts the question into a valid Cypher query based on the database schema.
qa_generation_template: Uses the results from the Cypher query to generate a natural language response for the user.
"""
import os
